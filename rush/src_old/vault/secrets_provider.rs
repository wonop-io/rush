...
pub trait SecretsProvider: Debug + Send + Sync {
    ...
    async fn get_secret(
        ...
        let secrets = self.get_secrets(product_name, component_name, environment).await?;
    ...
    async fn set_secret(
        ...
        let mut current_secrets = match self.get_secrets(product_name, component_name, environment).await {
            Ok(secrets) => secrets,
        ...
        self.set_secrets(product_name, component_name, environment, current_secrets).await
    }
    ...
    async fn delete_secret(
        ...
        // Get existing secrets first
        let mut current_secrets = self.get_secrets(product_name, component_name, environment).await?;
    ...
    async fn has_secret(
        ...
        match self.get_secrets(product_name, component_name, environment).await {
