...
**Location:** `rush/crates/rush-core/`
...
**Location:** `rush/crates/rush-build/`
...
**Location:** `rush/crates/rush-config/`
...
**Location:** `rush/crates/rush-container/`
...
**Location:** `rush/crates/rush-k8s/`
**Purpose:** Kubernetes manifest generation and deployment

#### Key Components
- Manifest builders for deployments, services, ingresses
- Sealed secret encoding with kubeseal
- Environment-specific configuration generation
- Validation utilities

### rush-local-services

**Location:** `rush/crates/rush-local-services/`
**Purpose:** Local service management (databases, message queues, etc.)

#### Key Components
- Docker-based service launchers
- Service health checks
- Port management
- Configuration templates for PostgreSQL, Redis, RabbitMQ, etc.

### rush-mcp

**Location:** `rush/crates/rush-mcp/`
**Purpose:** MCP (Model Context Protocol) server implementation

#### Key Components
- Protocol handlers for tool execution
...
**Location:** `rush/crates/rush-output/`
**Purpose:** Output formatting and routing system

#### Key Components
- Multiple sink implementations (console, file, web)
- Event routing and filtering
- Colored output formatting
- Component-based output control

### rush-security

**Location:** `rush/crates/rush-security/`
**Purpose:** Secret management and vault integration

#### Key Components
- Vault adapters (1Password, JSON, environment)
...
**Location:** `rush/crates/rush-toolchain/`
...
**Location:** `rush/crates/rush-utils/`
...
**Location:** `rush/crates/rush-helper/`
