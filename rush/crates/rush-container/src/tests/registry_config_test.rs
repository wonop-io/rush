...
#[cfg(test)]
mod tests {
    use crate::reactor::modular_core::{RegistryConfig, ModularReactorConfig};
    ...
    fn test_registry_tag_formatting() {
        ...
        let test_cases = vec![
            ("gcr.io", Some("my-project"), "app:v1.0", "gcr.io/my-project/app:v1.0"),
            ("docker.io", Some("library"), "nginx:latest", "docker.io/library/nginx:latest"),
            ("localhost:5000", None, "test:dev", "localhost:5000/test:dev"),
