...
impl DevEnvironment {
    ...
    pub fn register_local_services(&mut self, component_specs: &[ComponentBuildSpec]) -> Result<()> {
    ...
    fn register_stripe_service(&mut self, spec: &ComponentBuildSpec, command: Option<String>) -> Result<()> {
