...
pub fn parse_args() -> clap::ArgMatches {
    ...
    Command::new("rush")
        ...
        .arg(arg!(target_arch : --arch <TARGET_ARCH> "Target architecture: amd64, arm64, or native (default: native, uses host architecture)"))
        .arg(arg!(toolchain : --toolchain <TOOLCHAIN> "Toolchain mode: native (use system tools), or cross-compile target like x86, arm64 (default: matches --arch)"))
