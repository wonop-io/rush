...
mod tests {
    ...
    async fn test_secrets_integration_with_deployments() {
        ...
        secrets.insert("DATABASE_URL".to_string(), "postgres://localhost/mydb".to_string());
        ...
        assert!(secret.content.contains("cG9zdGdyZXM6Ly9sb2NhbGhvc3QvbXlkYg=="));
    }
    ...
    async fn test_volume_mounted_secrets() {
        ...
        assert!(deployment.content.contains("secretName: production-secrets"));
