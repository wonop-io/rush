...
| `rush-container/src/build/orchestrator.rs` | Bazel always rebuilds (2 locations) |
...
- [ ] Test Bazel builds locally (requires Bazel installation)
...
1. `docker-credential-desktop` is in PATH (for Docker Desktop users):
   ```bash
