...
Rush build succeeds:
```
Finished `release` profile [optimized] target(s) in 29.16s
```

Backend Bazel OCI build succeeds:
```
Target //src:load up-to-date: bazel-bin/src/load.sh
